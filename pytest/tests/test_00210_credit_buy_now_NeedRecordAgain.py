...
@pytest.mark.name("00210_Credit_Buy_Now")
def test_00210_credit_buy_now(actions: DriverActions):
    ...
    with step("[Action] Return from Debug Info to About"):
        actions.tap_within_element(AppiumBy.ACCESSIBILITY_ID, 'chevron.left', 50.0, 48.4, container_by=AppiumBy.XPATH, container_value='//XCUIElementTypeNavigationBar[@name="Develop Info"]', container_w=320, container_h=693)
