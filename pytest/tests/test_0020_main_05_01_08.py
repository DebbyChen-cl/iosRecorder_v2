...
@pytest.mark.name("test_main_05_01_08")
def test_test_main_05_01_08(actions: DriverActions):
    ...
    with step("[Action] Tap Denoise"):
        actions.tap_by_locator(AppiumBy.ACCESSIBILITY_ID, 'Denoise')
    with step("[Action] Tap Denoise"):
        actions.tap_by_locator(AppiumBy.ACCESSIBILITY_ID, 'Denoise')
    with step("[Verify] Eliminate the noise in your low light or high-ISO photos with our latest AI technology. is visible"):
        assert actions.verify_visible(AppiumBy.ACCESSIBILITY_ID, 'Eliminate the noise in your low light or high-ISO photos with our latest AI technology.'), 'element Eliminate the noise in your low light or high-ISO photos with our latest AI technology. should be visible'
    with step("[Action] Tap Try First"):
        actions.tap_by_locator(AppiumBy.ACCESSIBILITY_ID, 'Try First')
    with step("[Verify] Eliminate the noise in your low light or high-ISO photos with our latest AI technology. is not visible"):
        assert actions.verify_not_visible(AppiumBy.NAME, 'Eliminate the noise in your low light or high-ISO photos with our latest AI technology.'), 'element Eliminate the noise in your low light or high-ISO photos with our latest AI technology. should not be visible'
    ...
    with step("[Verify] Applying Denoise is not visible"):
        assert actions.verify_not_visible(AppiumBy.NAME, 'Applying Denoise'), 'element Applying Denoise should not be visible'
