...
@pytest.mark.name("test_main_05_01_11")
def test_test_main_05_01_11(actions: DriverActions):
    ...
    with step("[Action] Tap AI Color"):
        actions.tap_by_locator(AppiumBy.ACCESSIBILITY_ID, 'AI Color')
