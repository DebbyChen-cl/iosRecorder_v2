...
@pytest.mark.name("test_adjustment_sharpness")
def test_test_adjustment_sharpness(actions: DriverActions):
    ...
    with step("[Verify] Sharpness is not visible"):
        assert actions.verify_not_visible(AppiumBy.NAME, 'Sharpness'), 'element Sharpness should not be visible'
    with step("[Verify] //*[@name=\"Sharpness\"] is not visible"):
        assert actions.verify_not_visible(AppiumBy.XPATH, '//*[@name="Sharpness"]'), 'element //*[@name="Sharpness"] should not be visible'
    with step("[Verify] //*[@label=\"Sharpness\"] is not visible"):
        assert actions.verify_not_visible(AppiumBy.XPATH, '//*[@label="Sharpness"]'), 'element //*[@label="Sharpness"] should not be visible'
    with step("[Verify] //*[@value=\"Sharpness\"] is not visible"):
        assert actions.verify_not_visible(AppiumBy.XPATH, '//*[@value="Sharpness"]'), 'element //*[@value="Sharpness"] should not be visible'
