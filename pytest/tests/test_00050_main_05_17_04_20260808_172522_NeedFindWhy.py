...
def test_00050_main_05_17_04_20260808_172522(actions: DriverActions):
    ...
    with step("[Action] Drag _AT (83.3%,96.6%) → //XCUIElementTypeOther[@name=\"light_hits\"]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeOther/XCUIElementTypeOther[3]/XCUIElementTypeOther/XCUIElementTypeSlider (4.0%,51.0%)"):
        actions.drag_within_elements(AppiumBy.ACCESSIBILITY_ID, '_AT', 83.3, 96.6, AppiumBy.XPATH, '//XCUIElementTypeOther[@name="light_hits"]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeOther/XCUIElementTypeOther[3]/XCUIElementTypeOther/XCUIElementTypeSlider', 4.0, 51.0, duration=1.0)
    with step("[Verify] Capture '00050_main_05_17_04_Step10' for GT comparison"):
        actions.capture_for_gt('00050_main_05_17_04_Step10', AppiumBy.ACCESSIBILITY_ID, '_AT', threshold=0.95)
    with step("[Action] Drag _AT (17.7%,96.6%) → 0 (7.5%,50.0%)"):
        actions.drag_within_elements(AppiumBy.ACCESSIBILITY_ID, '_AT', 17.7, 96.6, AppiumBy.ACCESSIBILITY_ID, '0', 7.5, 50.0, duration=1.0)
    with step("[Verify] Capture '00050_main_05_17_04_Step12' for GT comparison"):
        actions.capture_for_gt('00050_main_05_17_04_Step12', AppiumBy.ACCESSIBILITY_ID, '_AT', threshold=0.95)
    ...
    with step("[Verify] Capture '00050_main_05_17_04_Step14' for GT comparison"):
        actions.capture_for_gt('00050_main_05_17_04_Step14', AppiumBy.ACCESSIBILITY_ID, '_AT', threshold=0.95)
    ...
    with step("[Verify] Capture '00050_main_05_17_04_Step16' for GT comparison"):
        actions.capture_for_gt('00050_main_05_17_04_Step16', AppiumBy.ACCESSIBILITY_ID, '_AT', threshold=0.95)
    ...
    with step("[Verify] Capture '00050_main_05_17_04_Step19' for GT comparison"):
        actions.capture_for_gt('00050_main_05_17_04_Step19', AppiumBy.ACCESSIBILITY_ID, '_AT', threshold=0.95)
    with step("[Action] Tap btn_flipH_n at (60.5%, 60.5%)"):
    ...
    with step("[Verify] Capture '00050_main_05_17_04_Step21' for GT comparison"):
        actions.capture_for_gt('00050_main_05_17_04_Step21', AppiumBy.ACCESSIBILITY_ID, '_AT', threshold=0.95)
    ...
    with step("[Verify] Capture '00050_main_05_17_04_Step23' for GT comparison"):
        actions.capture_for_gt('00050_main_05_17_04_Step23', AppiumBy.ACCESSIBILITY_ID, '_AT', threshold=0.95)
    ...
    with step("[Verify] Capture '00050_main_05_17_04_Step25' for GT comparison"):
        actions.capture_for_gt('00050_main_05_17_04_Step25', AppiumBy.ACCESSIBILITY_ID, '_AT', threshold=0.95)
    ...
    with step("[Action] Tap Softness at (61.9%, 72.7%)"):
        actions.tap_within_element(AppiumBy.ACCESSIBILITY_ID, 'Softness', 61.9, 72.7, container_by=AppiumBy.XPATH, container_value='//XCUIElementTypeOther[@name="light_hits"]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeOther/XCUIElementTypeOther[4]/XCUIElementTypeOther/XCUIElementTypeCollectionView', container_w=380, container_h=79)
    with step("[Verify] 0 text equals '0'"):
        actions.verify_text(AppiumBy.ACCESSIBILITY_ID, '0', '0')
    with step("[Action] Drag _AT (17.7%,96.6%) → 0 (0.0%,57.5%)"):
        actions.drag_within_elements(AppiumBy.ACCESSIBILITY_ID, '_AT', 17.7, 96.6, AppiumBy.ACCESSIBILITY_ID, '0', 0.0, 57.5, duration=1.0)
    ...
    with step("[Verify] Capture '00050_main_05_17_04_Step31' for GT comparison"):
        actions.capture_for_gt('00050_main_05_17_04_Step31', AppiumBy.ACCESSIBILITY_ID, '_AT', threshold=0.95)
    with step("[Action] Drag _AT (84.2%,97.3%) → //XCUIElementTypeOther[@name=\"light_hits\"]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeOther/XCUIElementTypeOther[3]/XCUIElementTypeOther/XCUIElementTypeSlider (5.8%,51.0%)"):
        actions.drag_within_elements(AppiumBy.ACCESSIBILITY_ID, '_AT', 84.2, 97.3, AppiumBy.XPATH, '//XCUIElementTypeOther[@name="light_hits"]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeOther/XCUIElementTypeOther[3]/XCUIElementTypeOther/XCUIElementTypeSlider', 5.8, 51.0, duration=1.0)
    with step("[Verify] 0 text equals '0'"):
        actions.verify_text(AppiumBy.ACCESSIBILITY_ID, '0', '0')
    with step("[Verify] Capture '00050_main_05_17_04_Step34' for GT comparison"):
        actions.capture_for_gt('00050_main_05_17_04_Step34', AppiumBy.ACCESSIBILITY_ID, '_AT', threshold=0.95)
    with step("[Action] Drag _AT (18.8%,98.0%) → 0 (10.0%,60.0%)"):
        actions.drag_within_elements(AppiumBy.ACCESSIBILITY_ID, '_AT', 18.8, 98.0, AppiumBy.ACCESSIBILITY_ID, '0', 10.0, 60.0, duration=1.0)
    ...
    with step("[Action] Drag _AT (51.4%,97.3%) → 0 (20.0%,67.5%)"):
        actions.drag_within_elements(AppiumBy.ACCESSIBILITY_ID, '_AT', 51.4, 97.3, AppiumBy.ACCESSIBILITY_ID, '0', 20.0, 67.5, duration=1.0)
    with step("[Verify] 100 text equals '100'"):
        actions.verify_text(AppiumBy.ACCESSIBILITY_ID, '100', '100')
    with step("[Verify] Capture '00050_main_05_17_04_Step39' for GT comparison"):
        actions.capture_for_gt('00050_main_05_17_04_Step39', AppiumBy.ACCESSIBILITY_ID, '_AT', threshold=0.95)
    with step("[Action] Drag _AT (83.3%,97.3%) → //XCUIElementTypeOther[@name=\"light_hits\"]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeOther/XCUIElementTypeOther[3] (1.4%,52.5%)"):
        actions.drag_within_elements(AppiumBy.ACCESSIBILITY_ID, '_AT', 83.3, 97.3, AppiumBy.XPATH, '//XCUIElementTypeOther[@name="light_hits"]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeOther/XCUIElementTypeOther[3]', 1.4, 52.5, duration=1.0)
    with step("[Verify] -100 text equals '-100'"):
        actions.verify_text(AppiumBy.ACCESSIBILITY_ID, '-100', '-100')
    with step("[Verify] Capture '00050_main_05_17_04_Step42' for GT comparison"):
        actions.capture_for_gt('00050_main_05_17_04_Step42', AppiumBy.ACCESSIBILITY_ID, '_AT', threshold=0.95)
    ...
    with step("[Action] Drag _AT (54.2%,91.4%) → 0 (7.5%,50.0%)"):
        actions.drag_within_elements(AppiumBy.ACCESSIBILITY_ID, '_AT', 54.2, 91.4, AppiumBy.ACCESSIBILITY_ID, '0', 7.5, 50.0, duration=1.0)
    with step("[Verify] Capture '00050_main_05_17_04_Step45' for GT comparison"):
        actions.capture_for_gt('00050_main_05_17_04_Step45', AppiumBy.ACCESSIBILITY_ID, '_AT', threshold=0.95)
    with step("[Action] Drag _AT (83.5%,91.4%) → Hue (92.5%,46.7%)"):
        actions.drag_within_elements(AppiumBy.ACCESSIBILITY_ID, '_AT', 83.5, 91.4, AppiumBy.ACCESSIBILITY_ID, 'Hue', 92.5, 46.7, duration=1.0)
    with step("[Verify] Capture '00050_main_05_17_04_Step47' for GT comparison"):
        actions.capture_for_gt('00050_main_05_17_04_Step47', AppiumBy.ACCESSIBILITY_ID, '_AT', threshold=0.95)
    with step("[Action] Drag _AT (54.0%,96.8%) → 0 (0.0%,52.5%)"):
        actions.drag_within_elements(AppiumBy.ACCESSIBILITY_ID, '_AT', 54.0, 96.8, AppiumBy.ACCESSIBILITY_ID, '0', 0.0, 52.5, duration=1.0)
    with step("[Verify] Capture '00050_main_05_17_04_Step49' for GT comparison"):
        actions.capture_for_gt('00050_main_05_17_04_Step49', AppiumBy.ACCESSIBILITY_ID, '_AT', threshold=0.95)
    with step("[Action] Drag _AT (84.9%,97.0%) → //XCUIElementTypeOther[@name=\"light_hits\"]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeOther/XCUIElementTypeOther[3]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeSlider (2.3%,40.8%)"):
        actions.drag_within_elements(AppiumBy.ACCESSIBILITY_ID, '_AT', 84.9, 97.0, AppiumBy.XPATH, '//XCUIElementTypeOther[@name="light_hits"]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeOther/XCUIElementTypeOther[3]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeSlider', 2.3, 40.8, duration=1.0)
    with step("[Verify] Capture '00050_main_05_17_04_Step51' for GT comparison"):
        actions.capture_for_gt('00050_main_05_17_04_Step51', AppiumBy.ACCESSIBILITY_ID, '_AT', threshold=0.95)
