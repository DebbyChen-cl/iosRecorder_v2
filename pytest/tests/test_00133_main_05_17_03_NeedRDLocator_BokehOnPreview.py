...
def test_00133_main_05_17_03(actions: DriverActions):
    ...
    if (actions.set_slider(AppiumBy.CLASS_NAME, 'XCUIElementTypeSlider', 100) and (actions.get_text(AppiumBy.ACCESSIBILITY_ID, 'valueLabel') in ('98', '99', '100'))):
        pass
    else:
    ...
    if (not actions.tap_by_locator(AppiumBy.ACCESSIBILITY_ID, 'Intensity')):
        ...
        if (actions.set_slider(AppiumBy.CLASS_NAME, 'XCUIElementTypeSlider', 100) and (actions.get_text(AppiumBy.ACCESSIBILITY_ID, 'valueLabel') in ('97', '98', '99', '100'))):
            pass
        else:
