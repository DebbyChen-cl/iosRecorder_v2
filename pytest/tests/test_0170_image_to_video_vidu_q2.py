...
@pytest.mark.name("test_image_to_video_vidu_q2")
def test_test_image_to_video_vidu_q2(actions: DriverActions):
    ...
    with step("[Action] Tap Vidu Q2"):
        actions.tap_by_locator(AppiumBy.ACCESSIBILITY_ID, 'Vidu Q2')
    with step("[Verify] Vidu Q2 is visible"):
        assert actions.verify_visible(AppiumBy.ACCESSIBILITY_ID, 'Vidu Q2'), 'element Vidu Q2 should be visible'
