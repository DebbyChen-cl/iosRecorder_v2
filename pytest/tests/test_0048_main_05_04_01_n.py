...
@pytest.mark.name("test_main_05_04_01_n")
def test_test_main_05_04_01_n(actions: DriverActions):
    ...
    with step("[Action] Tap CMS-UserImageItem1"):
        actions.tap_by_locator(AppiumBy.ACCESSIBILITY_ID, 'CMS-UserImageItem1')
    ...
    with step("[Action] Tap Filter"):
        actions.tap_by_locator(AppiumBy.ACCESSIBILITY_ID, 'Filter')
    with step("[Action] Tap CMS-UserImageItem2"):
