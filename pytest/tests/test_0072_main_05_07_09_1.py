...
@pytest.mark.name("test_main_05_07_09_1")
def test_test_main_05_07_09_1(actions: DriverActions):
    ...
    with step("[Action] Tap Toggle on withoutText"):
        actions.tap_by_locator(AppiumBy.ACCESSIBILITY_ID, 'Toggle on withoutText')
