...
@pytest.mark.name("test_adjustment_grain")
def test_test_adjustment_grain(actions: DriverActions):
    ...
    with step("[Action] Tap Grain"):
        actions.tap_by_locator(AppiumBy.ACCESSIBILITY_ID, 'Grain')
    assert True
