...
@pytest.mark.name("test_main_05_04a_05")
def test_test_main_05_04a_05(actions: DriverActions):
    ...
    with step("[Action] Tap Mirror"):
        actions.tap_by_locator(AppiumBy.ACCESSIBILITY_ID, 'Mirror')
    with step("[Action] Tap at (0, 0)"):
        actions.tap_by_coordinates(0, 0)
    with step("[Action] Tap btn mirrorfilter n"):
        actions.tap_by_locator(AppiumBy.ACCESSIBILITY_ID, 'btn mirrorfilter n')
    with step("[Action] Tap at (0, 0)"):
        actions.tap_by_coordinates(0, 0)
    with step("[Action] Tap at (50, 770)"):
        actions.tap_by_coordinates(50, 770)
    ...
    with step("[Action] Tap at (0, 0)"):
        actions.tap_by_coordinates(0, 0)
    with step("[Action] Tap at (120, 770)"):
        actions.tap_by_coordinates(120, 770)
    ...
    with step("[Action] Tap at (0, 0)"):
        actions.tap_by_coordinates(0, 0)
    with step("[Action] Tap at (190, 770)"):
        actions.tap_by_coordinates(190, 770)
    with step("[Action] Tap btn_ok_n"):
        actions.tap_by_locator(AppiumBy.ACCESSIBILITY_ID, 'btn_ok_n')
    with step("[Action] Tap btn mirrorfilter n"):
        actions.tap_by_locator(AppiumBy.ACCESSIBILITY_ID, 'btn mirrorfilter n')
    with step("[Action] Tap at (0, 0)"):
        actions.tap_by_coordinates(0, 0)
    with step("[Action] Tap at (260, 770)"):
        actions.tap_by_coordinates(260, 770)
    with step("[Action] Tap btn_ok_n"):
        actions.tap_by_locator(AppiumBy.ACCESSIBILITY_ID, 'btn_ok_n')
    with step("[Action] Tap btnCancel"):
        actions.tap_by_locator(AppiumBy.ACCESSIBILITY_ID, 'btnCancel')
