...
@pytest.mark.name("test_main_05_01_02")
def test_test_main_05_01_02(actions: DriverActions):
    ...
    with step("[Action] Tap Fisheye"):
        actions.tap_by_locator(AppiumBy.ACCESSIBILITY_ID, 'Fisheye')
