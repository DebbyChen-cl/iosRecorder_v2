...
@pytest.mark.name("test_image_to_video_kling_25_turbo")
def test_test_image_to_video_kling_25_turbo(actions: DriverActions):
    ...
    with step("[Action] Tap Kling 2.5 Turbo"):
        actions.tap_by_locator(AppiumBy.ACCESSIBILITY_ID, 'Kling 2.5 Turbo')
    with step("[Verify] Kling 2.5 Turbo is visible"):
        assert actions.verify_visible(AppiumBy.ACCESSIBILITY_ID, 'Kling 2.5 Turbo'), 'element Kling 2.5 Turbo should be visible'
