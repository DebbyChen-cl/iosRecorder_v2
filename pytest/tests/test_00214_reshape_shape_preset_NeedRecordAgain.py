...
@pytest.mark.name("00214_reshape_shape_preset")
def test_00214_reshape_shape_preset(actions: DriverActions):
    with step("[Action] Tap 'Edit'"):
        actions.tap_within_element(AppiumBy.ACCESSIBILITY_ID, 'Edit', 48.1, 28.0, container_by=AppiumBy.XPATH, container_value='//XCUIElementTypeOther[@name="LauncherProViewController"]/XCUIElementTypeScrollView', container_w=320, container_h=623)
