...
@pytest.mark.name("00211_Live_Element_Favorite")
def test_00211_live_element_favorite(actions: DriverActions):
    # --- Open Static Sticker ---
    ...
    # The picker closes after adding a sticker, so reopen Favorites to remove it.
    with step("[Action] Reopen Favorites from '+' > 'Add Sticker'"):
